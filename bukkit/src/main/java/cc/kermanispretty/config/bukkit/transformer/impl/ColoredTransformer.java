...
public class ColoredTransformer implements Transformer<Object, Colored, Object> {
    ...
    public Object transform(FieldContext fieldContext, Object object, Colored annotation, Config config) throws InvalidTransformExpectation {
        ...
        throw new InvalidTransformExpectation(config, fieldContext, "Invalid object type for LegacyColorTransformer, must be String or List<String>");
    }
}
